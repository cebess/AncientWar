...
public class PreferencesScreen implements Screen{
    ...
    private com.cebess.ancientwar.AncientWar gsm;
    private Stage stage;
    ...
    public PreferencesScreen(com.cebess.ancientwar.AncientWar gsm){
        this.gsm = gsm;
    ...
    public void show() {
        ...
        soundEffectsCheckbox.setChecked(gsm.getPreferences().isSoundEffectsEnabled());
